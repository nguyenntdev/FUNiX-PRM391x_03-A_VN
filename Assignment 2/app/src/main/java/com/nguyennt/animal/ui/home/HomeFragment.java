...
public class HomeFragment extends Fragment {
    ...
    public HomeFragment(Bundle bundle) {
        ...
        listBirds = bundle.getParcelableArrayList("listBirds");
        listSea = bundle.getParcelableArrayList("listSea");
        listMammals = bundle.getParcelableArrayList("listMammals");
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (type == 3) {
            adapter = new GridAdapter(getContext(), listMammals);
        } else if(type == 2) {
            adapter = new GridAdapter(getContext(), listSea);
        } else if(type == 1) {
            adapter = new GridAdapter(getContext(), listBirds);
        }
...
//                        Intent i = new Intent(view.getContext(), DetailActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getParentFragmentManager().setFragmentResultListener("animalKey", this, (requestKey, bundle) -> {
            ...
            if (type == 3) {
                listMammals.get(position).liked = bundle.getBoolean("liked");
            } else if(type == 2) {
                listSea.get(position).liked = bundle.getBoolean("liked");
            } else if(type == 1) {
                listBirds.get(position).liked = bundle.getBoolean("liked");
            }
